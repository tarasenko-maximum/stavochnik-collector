...
RETENTION_HOURS = 3      # сырые тики и записи вилок — только «сейчас» (табло/вилки прямо сейчас);
                          # линии/ставки/прибыль каждой сделки живут в vtrades и не удаляются (решение Максима 11.09)
PRUNE_EVERY_POLLS = 40   # раз в ~10 мин при шаге 15 с
